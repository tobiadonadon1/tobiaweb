...
interface GLSLHillsProps {
  ...
  planeSize?: number;
  speed?: number;
  /** Base (monochrome) color of the flowing topographic lines. */
  lineColor?: string;
  /** Overall opacity multiplier for the lines (helps them read on dark backgrounds). */
  opacity?: number;
...
const GLSLHills = ({
  ...
  useEffect(() => {
    ...
    // Three.js setup — antialias on to stop the thin moving lines from shimmering.
